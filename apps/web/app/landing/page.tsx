      ...
      <section id="features" className="py-20 sm:py-32 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
            {/* Feature 1 */}
            <div className="p-8 sm:p-10 rounded-2xl bg-card-soft border border-border-subtle hover:border-primary/35 transition-all group">
              ...
              <h4 className="text-xl sm:text-2xl font-bold text-text-strong mb-3 sm:mb-4">정밀 튜너</h4>
